...
Assuming for now that our DFT calculations are indeed accurate, this lack of correlation between the energies obtained from $r-\text{TiO}_2$ is not overly problematic; it could simply suggests that a purely classical two-body description of atomic interactions in $\text{TiO}_2$ in the amorphous or rutile phase is not sufficiently accurate to keep track of small changes in the system's configuration.
